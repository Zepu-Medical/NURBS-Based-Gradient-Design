...
WireParap=WirePara;
WireParas=WirePara;
WireParas.size_coil(1,:)=[];

% figure 
subplot(4,2,1)
NURBS_plot_2D(NURBS_curve_ini(1),Coil2D_ini(1),WireParap,{'-','.'},'control point',0,1);  %
xlabel('Integrated z-distance [m]')
ylabel('$\varphi\ [\pi/2]$',Interpreter='latex')
set(gca,'Linewidth',1,'XLim',[0,0.61],'FontName','Times New Roman','FontSize',12);

subplot(4,2,2)
NURBS_plot_2D(NURBS_curve_ini(2),Coil2D_ini(2),WireParas,{'-','.'},'control point',0,1);  % 
xlabel('Integrated z-distance [m]')
ylabel('$\varphi\ [\pi/2]$',Interpreter='latex')
set(gca,'Linewidth',1,'XLim',[0,0.67],'FontName','Times New Roman','FontSize',12);

subplot(4,2,3)
NURBS_plot_2D(NURBS_curve_step0(1),[],WireParap,{'-','.'},'control point',0,1);  %
xlabel('Integrated z-distance [m]')
ylabel('$\varphi\ [\pi/2]$',Interpreter='latex')
set(gca,'Linewidth',1,'XLim',[0,0.61],'FontName','Times New Roman','FontSize',12);

subplot(4,2,4)
NURBS_plot_2D(NURBS_curve_step0(2),[],WireParas,{'-','.'},'control point',0,1);  % 
xlabel('Integrated z-distance [m]')
ylabel('$\varphi\ [\pi/2]$',Interpreter='latex')
set(gca,'Linewidth',1,'XLim',[0,0.67],'FontName','Times New Roman','FontSize',12);
subplot(4,2,5)
NURBS_plot_2D(NURBS_curve_step1(1),[],WireParap,{'-','.'},'control point',0,1);  %
xlabel('Integrated z-distance [m]')
ylabel('$\varphi\ [\pi/2]$',Interpreter='latex')
set(gca,'Linewidth',1,'XLim',[0,0.61],'FontName','Times New Roman','FontSize',12);

subplot(4,2,6)
NURBS_plot_2D(NURBS_curve_step1(2),[],WireParas,{'-','.'},'control point',0,1);  % 
xlabel('Integrated z-distance [m]')
ylabel('$\varphi\ [\pi/2]$',Interpreter='latex')
set(gca,'Linewidth',1,'XLim',[0,0.67],'FontName','Times New Roman','FontSize',12);
subplot(4,2,7)
NURBS_plot_2D(NURBS_curve_step2(1),[],WireParap,{'-','.'},'control point',0,1);  %
xlabel('Integrated z-distance [m]')
ylabel('$\varphi\ [\pi/2]$',Interpreter='latex')
set(gca,'Linewidth',1,'XLim',[0,0.61],'FontName','Times New Roman','FontSize',12);

subplot(4,2,8)
NURBS_plot_2D(NURBS_curve_step2(2),[],WireParas,{'-','.'},'control point',0,1);  % 
xlabel('Integrated z-distance [m]')
ylabel('$\varphi\ [\pi/2]$',Interpreter='latex')
set(gca,'Linewidth',1,'XLim',[0,0.67],'FontName','Times New Roman','FontSize',12);
...
%% distance 
    ...
    NURBS_curve_ini=find_mindistance(NURBS_curve_ini,WirePara,near_wire,10,'off');
    NURBS_curve_step0=find_mindistance(NURBS_curve_step0,WirePara,near_wire,10,'off');
    NURBS_curve_step1=find_mindistance(NURBS_curve_step1,WirePara,near_wire,10,'off');
    NURBS_curve_step2=find_mindistance(NURBS_curve_step2,WirePara,near_wire,10,'off');
...
distance_all=[min(distance_ini{1,1}),min(distance_ini{2,1});
    min(distance_step0{1,1}),min(distance_step0{2,1});
    min(distance_step1{1,1}),min(distance_step1{2,1});
    min(distance_step2{1,1}),min(distance_step2{2,1});]
...
%% fasthenry input
    ...
    FastHenry_import(Cell_wire_step0,'standard_60cm_step0',WirePara);
    FastHenry_import(Cell_wire_step1,'standard_60cm_step1',WirePara);
    FastHenry_import(Cell_wire_step2,'standard_60cm_step2',WirePara);
