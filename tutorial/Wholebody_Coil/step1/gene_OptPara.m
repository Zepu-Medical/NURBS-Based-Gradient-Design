...
for c0=1:length(NURBS_curve)
    ...
    for c1=1:size(tmp_dis,1) 
        ...
        % tmp_ratio(c1,1)=ratio_rang(c0)*5/length(NURBS_curve(c0).dis{c1,2});  %*exp(0*NURBS_curve(c0).dis{c1,6}/(2*d0_rang(c0)))
        % tmp_ratio{c1,1}=ratio_rang(c0)*(NURBS_curve(c0).dis{c1,6}/d0_rang(c0)+d0_rang(c0)./NURBS_curve(c0).dis{c1,6});
        % tmp_ratio{c1,1}=ratio_rang(c0)./NURBS_curve(c0).dis{c1,6};%*exp(0*NURBS_curve(c0).dis{c1,6}/(2*d0_rang(c0))).*(d0_rang(c0)./NURBS_curve(c0).dis{c1,6});
        tmp_ratio{c1,1}=ratio_rang(c0).*exp(-NURBS_curve(c0).dis{c1,6}/(d0_rang(c0)*2));
    end
    
% tmp_ratio{c1,1}=ratio_rang(c0)*5/length(NURBS_curve(c0).dis{c1,2})*exp(0*NURBS_curve(c0).dis{c1,6}/(2*d0_rang(c0)))*d0_rang(c0)/NURBS_curve(c0).dis{c1,6};
