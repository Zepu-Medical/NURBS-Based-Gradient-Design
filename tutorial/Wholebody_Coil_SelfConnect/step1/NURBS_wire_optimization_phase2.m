...
Gbias_r=0.074*ones(1,size(target_para,1));   %0.049
...
if 1
    ...
    NURBS_surf(3).KnotChange([7])=1;
    % NURBS_surf(1).KnotChange([17,18,19])=1;
...
figure
    for c1=1:length(NURBS_surf)
         ...
         xlim([0,pi/2]);
      %  NURBS_plot(NURBS_curve_ini(c1),{'--'},'control point');
