...
Gbias_r=0.051*ones(1,size(target_para,1));   %0.049
...
if 1
    ...
    [min(distance_opt{1,1}),min(distance_opt{3,1})]
end



Cell_wire_eddy=Cell_wire_opt;% nurbs_fold2all(NURBS_curve_opt,WirePara.size_coil,WirePara.fold_condition,5);
...
if 1
    ...
    NURBS_surf(1).KnotChange([4,7,8,10,13])=1;
    NURBS_surf(1).KnotChange([9])=2;
